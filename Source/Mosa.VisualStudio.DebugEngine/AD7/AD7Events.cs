...
namespace Witschi.Debug.Engine.AD7
{
    ...
    sealed class AD7ProgramCreateEvent : AD7AsynchronousEvent, IDebugProgramCreateEvent2
    {
        ...
        internal static void Send(AD7Engine engine, IDebugProgram2 program)
        {
            AD7ProgramCreateEvent eventObject = new AD7ProgramCreateEvent();
            engine.Callback.Send(eventObject, IID, program, null);
        }
    }
    ...
    sealed class AD7ProcessDestroyEvent : AD7SynchronousEvent, IDebugProcessDestroyEvent2
    {
        ...
        public static void Send(AD7Engine engine, AD7Process process)
        {
            engine.Callback.Send(new AD7ProcessDestroyEvent(), IID, process);
        }
    }
    ...
    sealed class AD7EntrypointEvent : AD7StoppingEvent, IDebugEntryPointEvent2
    {
        ...
        public static void Send(AD7Engine engine, AD7Program program, AD7Thread thread)
        {
            engine.Callback.Send(new AD7EntrypointEvent(), IID, program, thread);
        }
    }
}
